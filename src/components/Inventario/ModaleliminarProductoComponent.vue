...
<template>
  <main
    class="w-full max-w-sm mx-auto bg-white p-8 rounded-md shadow-md z-999 fixed top-20 left-0 right-0"
  >
    <div class="mb-4">
      ...
      >
        {{ productoModificado.nombre_producto }}
      </p>
    </div>
    <div class="mb-4">
      <p
      ...
      >
        {{ productoModificado.codigo_barra_producto }}
      </p>
    </div>
    <div class="mb-4">
      <p
      ...
      >
        {{ productoModificado.precio_unitario }}
      </p>
    </div>
    <div class="mb-4">
      <p
      ...
      >
        {{ productoModificado.cantidad_producto_disponible }}
      </p>
    </div>
    <div class="mb-4">
      <p
      ...
      >
        {{ productoModificado.esta_disponible }}
      </p>
    </div>
...
export default {
  ...
  methods: {
    ...
    desactivarProducto() {
      axios
        .delete(API_URL + '/api/productos/' + this.productoModificado.codigo_barra_producto)
        .then((response) => {
