            ...
            <div class="col-span-3">
              <div>
                <label
                  ...
                  >Seleccione una unidad de medida</label
                >
                ...
                >
                  <option
                    v-for="unidadDeMedida in listaUnidadDeMedida"
                    :key="unidadDeMedida.id_unidad_de_medida"
                    :value="unidadDeMedida.id_unidad_de_medida"
                  >
                    {{ unidadDeMedida.nombre_unidad_de_medida }}
                  </option>
                </Field>
              </div>
...
export default {
  ...
  mounted() {
    ...
    this.precioExtra.id_precio_unidad_de_medida =
      this.precioExtraParametro.id_precio_unidad_de_medida
  },
  methods: {
    cerrarModal() {
    ...
    ponerNombreAUnidadDeMedida() {
      this.listaUnidadDeMedida.forEach((unidadMedida) => {
    ...
    obtenerUnidadesDeMedida() {
      axios
        .get(api_url + '/unidades_de_medida')
        .then((response) => {
