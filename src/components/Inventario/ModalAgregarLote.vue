          ...
          <Form @submit="enviarFormulario($event)">
            ...
            <div class="grid grid-cols-2 gap-4 mb-[1%]">
              <div class="">
                ...
                <input
                  type="date"
                  class="rounded-md border-slate-400 text-slate-500 w-[100%]"
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div class="">
                ...
                >
                  <option
                    v-for="precioUnidadMedida in listaUnidadesMedida"
                  ...
                  >
                    {{
                      ...
                      ':' +
                      precioUnidadMedida.cantidad_producto +
                      'unidades'
                    }}
                  </option>
                </select>
            ...
            <div class="grid grid-cols-2 gap-4 mb-[1%]">
              <div class="">
                ...
                <Field
                  type="number"
                  class="rounded-md border-slate-400 text-slate-500 w-[100%]"
                  v-model="cantidadIngresar"
                  name="cantidad_lotes"
                  :rules="validarCantidadLotes"
                />
                <ErrorMessage name="cantidad_lotes" class="error" />
              </div>
              <div class="">
                <label for="" class="block mb-[1%] font-semibold"
                  >Unidades totales a ingresar</label
                >
                <input
                  type="number"
                  class="rounded-md border-slate-400 text-slate-500 w-[100%]"
            ...
            <div class="grid grid-cols-2 gap-4 mb-[1%]">
              <div class="">
                ...
                <Field
                  type="number"
                  class="rounded-md border-slate-400 text-slate-500 w-[100%]"
                  v-model="nuevoPrecioUnitarioProducto"
            ...
            <div class="flex justify-center align-center mt-[3%] gap-4">
              ...
              <button
                @click="cerrarModal"
                type="button"
                class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 text-center"
              >
                Cancelar
              </button>
            </div>
...
export default {
  ...
  methods: {
    ...
    enviarFormulario(event, values) {
      ...
      axios
        .post('/api/gestion_existencias/', dataForm)
        .then((response) => {
          let lote = response.data.lote
          console.log(lote)
          this.$emit('guardarLoteNuevo', {
            lote: response.data.lote,
            mensaje: `Se agrego el lote ${lote.id_lote} con éxito`
          })
