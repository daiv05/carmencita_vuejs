    ...
    <Form>
      <div class="flex justify-center mt-4 mb-2">
        ...
        <div class="flex justify-center align-center">
          <button
            @click="obtenerDatosFiltrados($event)"
            class="bg-indigo-700 text-white font-medium rounded-[5px] h-[50%] mt-[19%] p-[5px]"
          >
            Aplicar filtro
          </button>
        </div>
...
export default {
  ...
  methods: {
    ...
    obtenerDatosFiltrados(event) {
      ...
      this.controlPagina = new ControlPaginas(
        this.urlEndpointFiltro + this.obtenerParmetrosFiltro(),
        axios
      )
      this.controlPagina.cargarPaginas()
    },
