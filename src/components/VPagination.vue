<template>
    ...
    <nav aria-label="Page navigation example" class="flex py-4 w-full">
        <ul class="inline-flex -space-x-px text-base h-10 mx-auto">
            <li>
                <button type="button" @click="updateCurrentPage(currentPage - 2)"
            ...
            <li v-for="(page, index) in paginas">
                <button type="button" @click="updateCurrentPage(page)"
            ...
            <li>
                <button type="button" @click="updateCurrentPage(currentPage)"
