          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              <div v-for="(item, index) in navigation" class="flex w-auto p-0 m-0">
                ...
                <Menu
                  v-if="index > 0 && index < navigation.length"
                  as="div"
                  class="relative ml-3 my-2"
                >
                  <div>
            ...
            >
              ...
              >
                <MenuItem v-slot="{ active }">
                  <div class="font-bold hover:bg-gray-100 p-2 pb-0 text-center">
                    {{ usuario.name }}
                  </div>
                </MenuItem>
                <MenuItem v-slot="{ active }">
                  <div class="font-semibold hover:bg-gray-100 py-0 text-center">
                    {{ usuario.email }}
                  </div>
                </MenuItem>
                <MenuItem v-slot="{ active }">
                  <div class="font-semibold hover:bg-gray-100 p-2 text-center">
