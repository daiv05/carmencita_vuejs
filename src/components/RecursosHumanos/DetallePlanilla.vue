<template>
  <div class="modal-mask" @click="cerrarModal()">
    <div
      class="h-[70%] p-[5%] max-w-[100%] mx-auto lg:max-w-[90%] bg-white p-3 rounded-md shadow-md z-999 fixed top-[15%] left-0 right-0 modal-content"
    >
      <table class="w-[100%]">
        <tr>
          <th colspan="6">
...
export default {
  ...
  methods: {
    ...
    cargarDetallesPlanillas() {
      axios
        .get('/api/obtener_detalles_planilla/' + this.idPlanilla)
        .then((response) => {
