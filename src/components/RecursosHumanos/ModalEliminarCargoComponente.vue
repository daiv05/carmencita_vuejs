...
export default {
  ...
  methods: {
    ...
    obtenerJornadaLaboral() {
      axios
        .get(api_url + '/jornadas_laborales_diarias/' + this.cargo.id_jornada_laboral_diaria)
        .then((response) => {
    ...
    eliminarCargo() {
      axios
        .delete(api_url + '/cargos/' + this.cargo.id_cargo)
        .then((response) => {
