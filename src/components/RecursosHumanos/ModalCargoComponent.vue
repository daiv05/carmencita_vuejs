        ...
        <Form @submit="guardarModificacionEmpleado()">
          ...
          <div class="mb-4">
            <Field
              ...
              v-model="cargoModificado.nombre_cargo"
          ...
          <div class="mb-4">
            <Field
              ...
              id="email"
              name="salario_cargo"
              placeholder="Sueldo del cargo"
              step="0.01"
              v-model="cargoModificado.salario_cargo"
          ...
          <div class="mb-4">
            <Field
              ...
              id="chat"
              v-model="cargoModificado.descripcion_cargo"
              rows="1"
          ...
          <div class="mb-4">
            ...
            >
              <option
                v-for="jornada in listaHorarioLaboral"
                v-bind:key="jornada.id_jornada_laboral_diaria"
                :value="jornada.id_jornada_laboral_diaria"
              >
...
export default {
  ...
  methods: {
    ...
    obtenerListaHorariosLaboral() {
      axios.get(api_url + '/jornadas_laborales_diarias').then((response) => {
    ...
    guardarModificacionEmpleado(values) {
      ...
      axios
        .put(api_url + '/cargos/' + this.cargoModificado.id_cargo, this.cargoModificado)
        .then((response) => {
