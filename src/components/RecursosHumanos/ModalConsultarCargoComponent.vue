...
<main class="w-full max-w-sm mx-auto bg-white p-8 rounded-md shadow-md z-999 fixed top-20 left-0 right-0">
      ...
      <div class="mb-4">
        ...
        <p class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500"
           id="nombre_cargo" name="nombre_cargo"
          > {{ cargoModificado.nombre_cargo }}</p>
      </div>
      <div class="mb-4">
        <p class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500"
           id="salario_cargo" name="salario_cargo"
          > {{ cargoModificado.salario_cargo }}</p>
      </div>
      <div class="mb-4">
        <Field  as="textarea" name="descripcion_cargo" id="descripcion_carga" v-model="cargoModificado.descripcion_cargo" rows="1"  class="block mx-0 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 
