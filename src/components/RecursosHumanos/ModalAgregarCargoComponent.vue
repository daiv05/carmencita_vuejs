...
<Form class="w-full h-auto max-w-sm mx-auto bg-white p-8 rounded-md shadow-md z-999 fixed top-20 left-0 right-0" @submit="guardarCargo()">
...
<div class="mb-4">
  <Field class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500"
    type="number" id="email" name="salario_cargo" placeholder="Sueldo del cargo" step="0.01" v-model = "salario_cargo"
    :rules="validarSalario"/>
    <ErrorMessage name = "salario_cargo"/>
</div>
<div class="mb-4">
  <Field  as="textarea" name="descripcion_cargo" id="chat" v-model="descripcion_cargo" rows="1"  class="block mx-0 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 
...
<div class="mb-4">
  ...
  v-model="id_jornada_laboral_diaria"
  :rules="validarHorario">
