      ...
      <div class="ofertas-container" ref="ofertasContainer">
        <div v-for="oferta in ofertasPaginadas" :key="oferta.id" class="oferta-card">
          <div class="imagen-container">
            <img v-bind:src= "baseUrl + '/productos/' + oferta.codigo_barra_producto + '/foto' " v-if="oferta.foto != '' " :alt="oferta.codigo_barra_producto" class="oferta-imagen" />
            <img v-else src="https://opelgtsource.com/assets/default_product.png" :alt="oferta.codigo_barra_producto" class="oferta-imagen" />
          </div>
