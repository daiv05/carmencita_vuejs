...
<template>
  ...
  >
      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <Field
                v-model="promocion.fecha_inicio_oferta"
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <Field
                v-model="promocion.fecha_fin_oferta"
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <Field
                v-model="promocion.nombre_oferta"
                name="nombre_oferta"
                rules="required"
                id="nombre_oferta"
                type="text"
          ...
          <div class="sm:col-span-3">
            <label for="precio_oferta" class="block text-sm font-medium leading-6 text-gray-900"
              >Precio de promoción</label
            >
            <div class="mt-2">
              <div class="mt-2 relative rounded-md shadow-sm">
                ...
                <Field
                  name="precio_oferta"
                  rules="required"
                  v-model="promocion.precio_oferta"
                  id="precio_oferta"
                  type="number"
                  min="0"
          ...
          <div class="sm:col-span-3">
            <label for="cantidad_producto" class="block text-sm font-medium leading-6 text-gray-900"
            ...
            <div class="mt-2">
              <div class="mt-2 relative rounded-md shadow-sm">
                <Field
                  ...
                  rules="required"
                  v-model="promocion.cantidad_producto"
          ...
          <div class="sm:col-span-3">
            <label
              for="codigo_barra_producto"
              class="block text-sm font-medium leading-6 text-gray-900"
              >Producto en promoción</label
            >
            <div class="mt-2">
              <Field
                as="select"
    ...
    <div class="flex items-center justify-center">
      <router-link
        to="/marketing/consultar_ofertas"
...
export default {
  ...
  methods: {
    getProductos() {
      axios
        .get(api_url + '/productoProm')
        .then(
          (response) => (
            (this.productos = response.data), this.createForm == false ? this.getOferta() : null
          )
        )
    },
    getOferta() {
      axios
        .get('api/oferta/' + this.id)
        .then(
          (response) => (
    ...
    savePromocion(values) {
      if (this.createForm == true) {
        ...
        axios
          .post(api_url + '/promociones', params)
          .then((response) => {
        ...
        axios
          .put(api_url + '/ofertaUpdate/' + this.id, params)
          .then((response) => {
            response.data.message.forEach((mensaje) => {
              showMessages(response.data.status, mensaje)
            })
    ...
    obtenerPrecioUnitario() {
      return new Promise((resolve, reject) => {
        ...
        const productoSeleccionado = this.productos.find(
          (producto) => producto.codigo_barra_producto == codigoBarraSeleccionado
        )
