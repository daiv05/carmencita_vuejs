  ...
  <Transition name="modal">
    <div v-if="show" class="modal-mask bg-white">
      <div class="modal-container">
        <p class="text-xl font-bold mb-6 text-center">Modificar proveedor</p>
        <div class="mb-4">
          ...
          <div class="grid grid-cols-2">
            ...
            <div class="col-span-1 mt-4">
              ...
              <input
                @input="formatear_nit(proveedor.nit_pr)"
                v-model="proveedor.nit_pr"
                type="text"
                id="nit"
                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                placeholder="NIT"
            ...
            <div class="col-span-1 mt-4 w-[50%] ml-4">
              ...
              <input
                @input="formatear_nrc(proveedor.nrc_pr)"
                v-model="proveedor.nrc_pr"
                type="text"
                id="nrc"
                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                placeholder="NRC"
  ...
  methods: {
    modificar_proveedor() {
      if (
        ...
        this.proveedor.nrc_pr == '' ||
        this.proveedor.nit_pr == ''
      ) {
      ...
      axios
        .put(api_url + '/proveedor/' + this.proveedor.id, this.proveedor)
        .then((res) => {
          this.watch_toast('success', 'Proveedor actualizado exitosamente')
          this.$emit('close')
        })
        .catch((err) => {
          console.log(err)
