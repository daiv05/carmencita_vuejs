      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            <label for="fecha_credito" class="block text-sm font-medium leading-6 text-gray-900"
              >Fecha del crédito</label
            >
            <div class="mt-2">
              <Field
                v-model="credito.fecha_credito"
                name="fecha_credito"
                rules="required"
                id="fecha_credito"
                type="Date"
          ...
          <div class="sm:col-span-3">
            <label for="fecha_limite_pago" class="block text-sm font-medium leading-6 text-gray-900"
              >Fecha limite de pago</label
            >
            <div class="mt-2">
              <Field
                v-model="credito.fecha_limite_pago"
          ...
          <div class="sm:col-span-3">
            <label for="detalle_credito" class="block text-sm font-medium leading-6 text-gray-900"
              >Detalle del crédito</label
            >
            <div class="mt-2">
              <Field
                v-model="credito.detalle_credito"
                name="detalle_credito"
                rules="required"
                id="detalle_credito"
                type="text"
                placeholder="Ingresa los detalles del crédito"
                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
          ...
          <div class="sm:col-span-3">
            <label for="monto_credito" class="block text-sm font-medium leading-6 text-gray-900"
              >Monto</label
            >
            <div class="mt-2">
          ...
          <div class="sm:col-span-3">
            <label for="id_proveedor" class="block text-sm font-medium leading-6 text-gray-900"
              >Proveedor</label
            >
            <div class="mt-2">
              <Field
  ...
  methods: {
    ...
    saveCredito(values) {
      if (this.createForm != null) {
        ...
        axios
          .post(api_url + '/creditosProveedores', params)
          .then((response) => {
