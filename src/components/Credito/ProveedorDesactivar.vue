    ...
    <div v-if="show" class="modal-mask bg-white">
      <div class="modal-container">
        ...
        <div class="mb-4 flex flex-row items-center justify-center">
          <p v-if="proveedor.estado_pr == 1" for="fecha_pedido text-center">
            ¿Está seguro que desea desactivar a este proveedor?
          </p>
          <p v-else for="fecha_pedido text-center">
            ¿Está seguro que desea activar a este proveedor?
          </p>
        </div>
        <div class="mb-4 flex flex-row items-center justify-center">
          <p v-if="proveedor.estado_pr == 1" class="text-center font-bold text-blue-950">
            La selección del proveedor dejará de estar disponible en el registro de créditos
          </p>
          <p v-else class="text-center font-bold text-blue-950">
            El proveedor estará disponible en el registro de créditos
          </p>
        </div>
        <div>
          <div class="text-center">
            <button
              @click="desactivar_proveedor()"
...
export default {
  ...
  methods: {
    desactivar_proveedor() {
      axios
        .put(api_url + '/proveedor/cambiar_estado/' + this.proveedor.id)
        .then((response) => {
