    ...
    <div class="flex justify-center">
      ...
      >
        <div class="max-w-2xl p-6 bg-white rounded-md shadow-xl">
          ...
          <div class="flex items-center justify-between">
            <h3 class="text-2xl text-center w-full" v-if="estado">
              Anular venta de credito fiscal?
            </h3>
            <h3 class="text-2xl text-center w-full" v-if="!estado">
              ¿Activar venta de credito fiscal?
            </h3>
          </div>
          <div class="mt-4 text-center">
            <p class="mb-4 text-lg text-center" v-if="estado">
              La venta de credito fiscal se anulara y no se podrá recuperar. Los detalles asociados
              a esta venta serán desactivados.
            </p>
            <p class="mb-4 text-lg text-center" v-if="!estado">
              La venta de credito fiscal se activara y se podrá recuperar. Los detalles asociados a
              esta venta serán activados.
            </p>
            <div v-if="estado">
              <button
                @click="isOpen = false"
...
export default {
  ...
  methods: {
    desactivarVenta() {
      ...
      axios.put(api_url + '/creditos/updateEstado/' + this.id).then((response) => {
