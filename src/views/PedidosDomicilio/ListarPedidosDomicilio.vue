        ...
        <div class="bg-slate-100 pb-4">
            ...
            <div class="container grid grid-cols-2 md:grid-cols-4 p-6 pt-4 w-4/5 mx-auto">
                <div class="col-span-1 flex flex-col justify-center p-2">
                    ...
                    <div class="">
                        <select v-model="estado" name="estado" id="estado" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <div class="col-span-1 flex flex-col justify-center p-2">
                    ...
                    <div>
                        <select v-model="tipo" name="tipo" id="tipo" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            <option disabled >Seleccione...</option>
                ...
                <div class="col-span-1 flex flex-col justify-center p-2">
                    ...
                    <div><input v-model="fecha" type="Date" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></div>
                </div>
                <div class="col-span-1 flex justify-center align-middle">
                    <button @click="filtrarPedidos" class="bg-blue-500 px-3 py-2 rounded text-slate-50 h-fit flex m-auto">Aplicar filtros</button>
                </div>
            </div>
            <!--Tabla de pedidos-->
            <div class="container w-full m-1 md:w-11/12 lg:w-4/5 p-4 sm:mx-auto bg-slate-50 shadow rounded-md overflow-scroll lg:overflow-auto">
