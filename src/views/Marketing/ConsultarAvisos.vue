        ...
        >
          ...
          <td class="text-center p-[1%]">
            <div class="grid grid-cols-10">
              ...
              <div class="col-span-2"><BotonEliminarAviso :url="obtenerUrlEliminarAviso(aviso.id)" titulo="Eliminar aviso" mensaje="¿Desea eliminar el aviso?" :index="controlPagina.obtenerPosicionElemento(aviso)" :lista="controlPagina.obtenerListaResultadoPorPagina()"></BotonEliminarAviso></div>
