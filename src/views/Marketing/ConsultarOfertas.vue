      ...
      <div>
        <div class="flex bg-white mx-auto p-5 shadow-md justify-between">
          ...
          <div class="flex items-center rounded-[4.44px] bg-[#637381]">
            <router-link
              to="/marketing/registrar_promociones"
          ...
          <tr v-for="oferta in controlPagina.datosPagina" :key="oferta.id" class="border-b">
            ...
            <td class="text-center p-1">
              <div class="grid grid-cols-2">
                ...
                <BotonEliminarAviso
                  :url="obtenerUrlEliminarOferta(oferta.id)"
                  titulo="Eliminar Oferta"
                  mensaje="¿Desea eliminar la oferta?"
                  :index="controlPagina.obtenerPosicionElemento(oferta)"
