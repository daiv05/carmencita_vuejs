<template>
    ...
    <div class="w-full h-[60px]">
      ...
      >
        ...
        <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 z-999 fixed top-20" role="alert"
        v-if="mensajeExito!=' '">
        <span class="font-medium">Mensaje de éxito!</span> {{ mensajeExito }}
        </div>
        <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 z-999 fixed top-20" role="alert"
        v-if="listaErrores">
        ...
        <div class="grid grid-cols-10 gap-1 w-[80%] m-auto bg-white p-[2%] rounded-[2px] mt-[1%]"
             style="
          box-shadow: 0px 1.11px 3.329166889190674px 0 rgba(0, 0, 0, 0.1),
          0px 1.11px 2.219444513320923px 0 rgba(0, 0, 0, 0.06);
           "
        >
            ...
            <div class="col-span-3 h-[100%]">
                ...
                <div class="mt-[5%]">
                    ...
                    <Field type="date" name ="fecha_finalizacion" id="fecha_finalizacion" class="p-[5px] rounded-[5px] border border-slate-300 w-[100%]"
                    :rules="validarFecha" v-model="fecha_finalizacion"/>
            ...
            <div class="col-span-7">
                <div class="ml-[10%]">
                    ...
                    <Field type="text" class="border border-slate-200 block w-[100%] rounded-[5px] shadow-md" name="titulo"
                    :rules="validarTexto" v-model="titulo_aviso"/>
                ...
                <div class="ml-[10%] mt-[3%]">
                    ...
                    :rules="validarTexto" v-model="cuerpo_aviso"/>
