...
<template>
  <main>
    ...
    <div class="w-[80%] mx-auto mt-8">
      ...
      <Form @submit="guradarCambiosProducto($event)">
          ...
          <div class="grid grid-cols-5">
            <div class="col-span-3">
              <div class="mb-[4%]">
                ...
                <Field
                  type="text"
                  class="w-[100%] border-1 rounded border-slate-300"
              ...
              <div class="mb-[4%]">
                ...
                <Field
                  ...
                  v-model="producto.codigoBarraProducto"
              ...
              <div class="mb-[4%] flex flex-wrap">
                <div class="">
                  <label for="cantidad_disponible" class="block mb-[0.5%]"
                    >Cantidad Disponible</label
                  >
                  <Field
                    type="text"
                    class="w-[90%] border-1 rounded border-slate-300"
                    name="cantidad_disponible"
                    placeholder="Cantidad"
                    v-model="producto.cantidadProductoDisponible"
                    :rules="validarCantidadDisponible"
                  />
                  <ErrorMessage
                    name="cantidad_disponible"
                    class="mensajeDeError corregirLongitud"
                  />
                </div>
                <div class="">
                  ...
                  <Field
                    ...
                    placeholder="Cantidad Fisica"
                    v-model="producto.cantidadProductoFisico"
                ...
                <div class="mb-4">
                  ...
                  <Field
                    type="text"
                    class="w-[80%] border-1 rounded border-slate-300"
                    name="precio_unitario"
                    placeholder="Precio"
                    v-model="producto.precioUnitarioProducto"
                    :rules="validarPrecioUnitario"
                  />
                ...
                <div class="grow">
                  ...
                  <div class="my-[5%]">
                    <Field
                      type="checkbox"
                      class="border-1 rounded border-slate-300"
                      name="activo"
                      value="activo"
                      v-model="producto.estaActivoProducto"
                    />
                    <label for="activo" class="inline-block text-slate-500 ml-[1%]"
            ...
            <div class="col-span-2 ml-[5%]">
              <div class="flex justify-center">
                ...
                <img
                  class="h-28 w-28 text-gray-300 rounded-full mb-[1%]"
                  v-bind:src="urlFotoProducto"
              ...
              <div>
                <div
                  class="flex justify-center rounded-lg border border-dashed border-gray-900/25 px-2 py-2 hover:border-indigo-800"
                  @drop="cargarImagenDrop($event)"
                  @dragover="detenerCargaPorEventoArrastre($event)"
                >
          ...
          <div class="grid grid-cols-6">
              ...
              <table class="w-[100%]">
                <thead>
                  <tr class="uppercase text-slate-500">
                    <th>
                      <p class="bg-slate-50 p-2 border-b-2 w-[90%]">Medida</p>
                    </th>
                    <th>
                ...
                <tbody>
                  <tr
                    class="border-b-2"
                    v-for="precioExtra in listaPrecios"
                  ...
                  >
                    ...
                    <td class="text-center p-3">
                      <button
                        ...
                        @click="editarPrecioExtra(precioExtra)"
                      >
                        Editar
                      </button>
                    </td>
                    <td class="text-center p-3">
                      <div class="mt-[6%]">
                        <button
                          ...
                          @click="eliminarPrecioExtra(precioExtra)"
                        >
                          X
                        </button>
                      </div>
            ...
            <div class="col-span-2">
              <button
                ...
                @click="controlModalPrecioExtra = true"
              >
        ...
        <div class="flex justify-center">
          ...
          <button
            type="submit"
            class="bg-indigo-500 text-white text-sm font-bold py-2 px-4 rounded-md hover:bg-indigo-600 transition duration-300 m-4"
          >
            Guardar Cambios
          </button>
        </div>
    ...
    <Teleport to="body">
      <ModalPrecioExtra
        v-if="controlModalPrecioExtra"
        @controlEventoModal="controlEventoModal"
      ></ModalPrecioExtra>
    </Teleport>
    <Teleport to="body">
      <ModalEditarPrecioExtra
        v-if="controlModalEditarPrecioExtra"
...
export default {
  ...
  methods: {
    ...
    cargarFoto(nombreFoto) {
      if (nombreFoto != '') {
        axios
          .get(api_url + '/productos/' + this.idProducto + '/foto', { responseType: 'arraybuffer' })
          .then((response) => {
      ...
      axios
        ...
        .catch((response) => {
          if (response.response.data.status === false) {
            this.mensajeExito =
              'El codigo de barra de producto que envio de parametro no se encuentar en la base de datos'
    ...
    cargarPreciosExtra(codigoBarraProducto) {
      axios
        .get(api_url + '/precio_lista_unidades/' + this.producto.codigoBarraProducto)
        .then((response) => {
          ...
          for (let i = 0; i < tempListaPreciosExtra.length; i++) {
            ...
            tempPrecioExtra.id_precio_unidad_de_medida =
              tempListaPreciosExtra[i].id_precio_unidad_de_medida
            tempPrecioExtra.nombreUnidadDeMedida =
              tempListaPreciosExtra[i].unidad_de_medida.nombre_unidad_de_medida
    ...
    controlEventoModalEditarPrecioExtra(precioExtra) {
      if (precioExtra != null) {
        ...
        for (let itemPrecioExtra of this.listaPrecios) {
          if (
            itemPrecioExtra.id_precio_unidad_de_medida == precioExtra.id_precio_unidad_de_medida
          ) {
    ...
    guradarCambiosProducto() {
      ...
      axios
        .post(api_url + '/productos/' + this.idProducto + configuracionPut, bodyData)
        .then((response) => {
    ...
    guardarCambiosListaPrecios() {
      ...
      axios
        .post(api_url + '/precio_lista_unidades/' + this.idProducto + configuracionUrlPut, dataBody)
        .then((response) => {
