...
<div class="max-w-2xl mx-auto">
    ...
    <nav class="flex justify-center text-center">
        ...
        <Teleport to="body">
            <ModalConsultarProductoComponent :productoParametro="productoSeleccionado" v-if="controlModalProducto" @cerrarModal="cerrarModal"></ModalConsultarProductoComponent>
        </Teleport>
