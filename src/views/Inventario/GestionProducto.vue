                                        ...
                                        <tr class="border-b-2 border-black-400 h-[40px] bg-black-300" v-for="producto in even(listaProductos, estado)" v-bind:key="producto.codigo_barra_producto">
                                            <td class="cursor-pointer px-4 py-3 text-center casillaClick hover:bg-gray-100" @click="mostrarProducto(producto.codigo_barra_producto)">
                                                <div class="flex items-center">
                                                    ...
                                                    <img :src="notImg" v-if="producto.foto == '' " alt="" class="w-10 h-10 rounded-full mr-4">
                    ...
                    <nav class="flex justify-center text-center">
                        <ul class="inline-flex -space-x-px">
                            <li @click="obtenerPaginaAnterior()">
                                <a href="#"
                                    class="bg-white border border-gray-300 text-gray-500 hover:bg-gray-100 hover:text-gray-700 ml-0 rounded-l-lg leading-tight py-2 px-3 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Anterior</a>
                            </li>
                            ...
                            <li @click="obtenerPaginaSiguiente()">
                                <a href="#"
                                    class="bg-white border border-gray-300 text-gray-500 hover:bg-gray-100 hover:text-gray-700 rounded-r-lg leading-tight py-2 px-3 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Siguiente</a>
                            </li>
                        </ul>
                    </nav>
