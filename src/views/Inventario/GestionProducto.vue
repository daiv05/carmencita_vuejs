...
<template>
  <main>
    ...
    <div>
      <div class="flex bg-white mx-auto p-5 shadow-md justify-between">
        ...
        <div class="flex items-center rounded-[4.44px] bg-[#637381]">
          <router-link
            to="/ventas_inventarios/agregar_producto"
                ...
                <table class="table-auto">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <button
                        @click="aplicarFiltro"
                        class="bg-blue-500 my-1 text-white px-4 py-2 rounded-lg hover:bg-sky-700"
                      >
                        Aplicar Filtro
                      </button>
                    </tr>
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full">
                  ...
                  <tbody class="bg-white">
                    ...
                    >
                      <td
                        class="cursor-pointer px-4 py-3 text-center casillaClick hover:bg-gray-100"
                      ...
                      >
                        <div class="flex items-center">
                          <img
                            ...
                            v-bind:src="
                              api_url + '/productos/' + producto.codigo_barra_producto + '/foto'
                            "
                            v-if="producto.foto != ''"
                      ...
                      <td class="px-4 py-3 text-ms font-semibold text-center">
                        {{ producto.cantidad_producto_disponible }}
                      </td>
                      <td class="px-4 py-3 text-xs text-center">
                        <button
                          ...
                          @click="modificarProducto(producto.codigo_barra_producto)"
                        >
                          Editar
                        </button>
                        <DesactivarProducto
                          :estado="producto.esta_disponible"
        ...
        <div class="max-w-2xl mx-auto">
          <nav class="flex justify-center text-center">
            <ul class="inline-flex -space-x-px">
              ...
              <li
                v-if="calcularNumeroPaginas() > 0"
                v-for="page in calcularNumeroPaginas()"
                @click="obtenerPaginaProducto(page)"
                :id="crearIdPaginacion(page)"
              >
                <a
                  href="#"
                  :class="{ pageActivate: page === controlPagina }"
    ...
    <Teleport to="body">
      <ModalConsultarProductoComponent
        :productoParametro="productoSeleccionado"
        v-if="controlModalProducto"
...
export default {
  ...
  beforeMount() {
    if (
      this.$store.state.existenDatos == true &&
      this.$store.state.fromAgregarEditarProducto == true
    ) {
  ...
  methods: {
    ...
    obtenerPaginaProducto(page) {
      axios
        .get(this.enlacesPaginaProducto[page].url)
        .then((response) => {
          //this.productoPaginado = response.data.productos;
          this.listaProductos = []
    ...
    cargarFoto(producto) {
      if (producto.foto != '') {
        axios
          .get(api_url + '/productos/' + producto.codigo_barra_producto + '/foto', {
