    ...
    <div>
      <div class="flex bg-white mx-auto p-5 shadow-md justify-between">
        ...
        <div class="flex items-center rounded-[4.44px] bg-[#637381]">
          <button
            class="w-auto h-auto my-2 mx-4 text-[13px] font-medium text-center text-white"
            ...
            <td>
              <div class="flex justify-center content-center">
                <button
                  ...
                  @click="abrirModalConsultar(lote)"
                >
                  Consultar
                </button>
                <button
                ...
                <button
                  ...
                  @click="abrirModalEliminacion(lote)"
                >
                  Eliminar
                </button>
              </div>
