...
<template>
  <main>
    <div
      class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 fixed top-20 left-0 right-0"
      role="alert"
    ...
    <div
      class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 fixed top-20 left-0 right-0"
      role="alert"
                    ...
                    <td class="flex justify-center items-center p-3">
                      <p>
                        <button
                          ...
                          @click="eliminarPrecioExtra(precioExtra.idUnidadMedida)"
                        >
                          X
                        </button>
                      </p>
...
export default {
  ...
  methods: {
    ...
    guradarProducto(event) {
      ...
      axios
        .post(api_url + '/productos', bodyFormData)
        .then((response) => {
    ...
    eliminarPrecioExtra(idUnidadMedida) {
      this.listaPrecios = this.listaPrecios.filter(
        (precioExtra) => precioExtra.idUnidadMedida != idUnidadMedida
      )
    },
    ...
    guaradarListaPrecios() {
      ...
      axios
        .post(api_url + '/precios_lista_unidades_de_medida', dataBody)
        .then((response) => {
          this.mensajeExito = response.data.mensaje
          this.contorlAlerta()
          this.clearForm()
