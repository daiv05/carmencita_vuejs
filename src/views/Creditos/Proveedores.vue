<template>
        ...
        <tbody class="text-center">
          ...
          >
            ...
            <td class="whitespace-nowrap px-4 py-4">
              <button
                @click="modal_editar_proveedor(proveedor)"
              ...
              <button
                @click="modal_estado_proveedor(proveedor)"
                v-if="proveedor.estado_pr == 1"
              ...
              <button
                @click="modal_estado_proveedor(proveedor)"
                v-else
                class="text-sm bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded-full m-1"
              >
                Activar
              </button>
            </td>
  ...
  <Teleport to="body">
    <ModalAgregarProveedor
      ...
      @close="cerrar_modales()"
    >
    </ModalAgregarProveedor>
  </Teleport>
  <Teleport to="body">
    <ModalModificarProveedor
      :show="show_modal_modificar"
...
export default {
  ...
  methods: {
    ...
    cerrar_modales(){
      ...
      this.show_modal_modificar = false
      this.show_modal_estado = false
      this.getproveedores()
    }
  }
}
