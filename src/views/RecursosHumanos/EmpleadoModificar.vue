...
<template>
    ...
    <div class="container bg-white shadow m-auto p-6 w-4/5 my-4">
        <div class="border-b border-gray-900/10 pb-12">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 class="mt-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Datos personales</h2>
            </div>
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="mt-2">
                    <Field v-model="empleado.primer_nombre" name="primer_nombre" rules="required" id="primer_nombre" type="text" placeholder="Ingresa tu primer nombre" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                ...
                <div class="mt-2">
                    <Field v-model="empleado.segundo_nombre" name="segundo_nombre"  id="segundo_nombre" type="text" placeholder="Ingresa tu segundo nombre" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                </div>
                </div>

                <div class="sm:col-span-3">
                <label for="primer_apellido" class="block text-sm font-medium leading-6 text-gray-900">Primer apellido</label>
                <div class="mt-2">
                    <Field v-model="empleado.primer_apellido" name="primer_apellido" rules="required" id="primer_apellido" type="text" placeholder="Ingresa tu primer apellido" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                ...
                <div class="mt-2">
                    <Field name="segundo_apellido" rules="required" id="segundo_apellido" type="text" placeholder="Ingresa tu segundo apellido" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
                </div>
                ...
                <div class="mt-2">
                    <Field v-model="empleado.fecha_nacimiento" name="fecha_nacimiento" rules="required" id="fecha_nacimiento" type="Date" placeholder="Ingresa tu primer nombre" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                ...
                <div class="sm:col-span-3">
                <label for="profesion" class="block text-sm font-medium leading-6 text-gray-900">Profesión u oficio</label>
                <div class="mt-2">
                    <Field name="profesion_oficio" rules="required" v-model="empleado.profesion_oficio" id="profesion" type="text" placeholder="Ingresa profesion u oficio" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                ...
                <div class="mt-2">
                    <Field name="domicilio" rules="required" v-model="empleado.domicilio" id="domicilio" type="text" placeholder="Ingresa tu primer nombre" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
  ...
  <!--submit button-->
    <div class="flex items-center justify-center">
        ...
        <button @click="saveEmpleado" class=" m-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
            Enviar
        </button>
    </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            saveEmpleado(values){
                alert('http://127.0.0.1:8000/api/empleado_update/'+this.id);
                const params = {
