...
<template>
    <NavBar></NavBar>
    <div class = "w-full mx-auto p-5 shadow-md" 
    ...
    <div style="background-color: #edf1fc;">
        <div class="container m-auto p-3 pb-0 w-4/5 my-0">
...
export default {
    ...
    mounted(){
        ...
        this.esta_activo = this.$refs.empleado.getEmpleado;
    }
}
</script>