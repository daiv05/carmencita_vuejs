  ...
  <main class="bg-gray-100">
    ...
    <section class="bg-gray-100">
      <section class="container mx-auto p-6 z-900">
        <Teleport to="body">
          <div
            class="z-999 fixed top-36 left-0 right-0 p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
            role="alert"
          ...
          <table class="table w-full max-h-screen rounded-md">
            ...
            <tbody>
              <tr
                ...
                v-bind:key="cargo.id_cargo"
              >
                <td
                  class="cursor-pointer px-4 py-3 text-center hover:bg-gray-100"
                ...
                <td class="px-4 py-3 text-xs text-center">
                  <button
                    ...
                    @click="modificarCargo(cargo.id_cargo)"
                  >
                    Editar
                  </button>
                  <button
                    ...
                    @click="eliminarCargo(cargo.id_cargo)"
                  >
                    Eliminar
                  </button>
                </td>
    ...
    <Teleport to="body">
      <ModalEliminarCargoComponenteVue
        v-if="controlModalEliminar"
        @cerrarModalEliminar="cerrarModalEliminar"
        :cargo="cargoParametro"
      ></ModalEliminarCargoComponenteVue>
    </Teleport>
    <Teleport to="body">
      <ModalConsultarCargoComponent
...
export default {
  ...
  methods: {
    getCargos() {
      axios.get(api_url + '/cargos').then((response) => {
