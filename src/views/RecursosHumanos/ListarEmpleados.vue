...
<template>
  ...
  <main class="bg-slate-100">
    <div>
      <div class="flex bg-white mx-auto p-5 shadow-md justify-between">
        ...
        <div class="flex items-center">
          <router-link
            to="/recursos_humanos/empleado_agregar"
            class="buttonColor w-auto h-auto px-4 py-2 rounded-[4.44px] text-[13px] font-medium text-center text-white"
    ...
    <div
      class="container w-full m-1 md:w-11/12 lg:w-4/5 p-4 sm:mx-auto bg-slate-50 shadow rounded-md overflow-auto lg:overflow-auto"
    >
