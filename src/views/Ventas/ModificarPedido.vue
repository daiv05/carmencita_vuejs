                ...
                <table class="table-fixed w-full shadow-lg">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td class="text-center">
                        ${{
                          fila.producto.precio_unitario_mostrar
                            ? fila.producto.precio_unitario_mostrar
  ...
  methods: {
    getVenta() {
      return new Promise((resolve, reject) => {
        resolve()
        axios.get(api_url + '/ventasCF_detalle/' + this.id).then((response) => {
          console.log(response.data),
            ...
            response.data.ventaCF.venta_domicilio == null
    ...
    register_new_venta() {
      ...
      if (this.active_tab == 0) {
        ...
        axios
          .put(
            api_url + '/modificar_pedido_factura/' + this.id,
            (datos_ventas = {
              venta: {
