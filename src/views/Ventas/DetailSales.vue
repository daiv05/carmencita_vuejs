            ...
            <div class="flex max-h-[300px] overflow-y-auto pb-36">
              <div class="w-3/4 pr-4 h-full pt-4">
                ...
                <table v-if="ventaCF" class="table-fixed w-full shadow-lg">
                  ...
                  <tbody>
                    <tr
                      v-for="(item, i) in ventaCF.ventaCF.detalle_venta"
                      :key="item.id_venta"
                    ...
                    >
                      ...
                      <td class="text-center">
                        $ {{ Number(item.subtotal_detalle_venta).toFixed(2) }}
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div class="flex md:flex-row flex-col items-center py-4 px-4">
                  ...
                  <div class="flex flex-col md:mr-16">
                    ...
                    <input
                      ...
                      disabled
                      v-for="detalle in ventaCF"
                      v-model="detalle.fecha_venta"
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="flex flex-col md:mr-16">
                    ...
                    <input
                      ...
                      v-for="detalle in ventaCF"
                      v-model="detalle.nombre_cliente_venta"
                      disabled
                    />
                  </div>
                </div>
...
export default {
  ...
  methods: {
    getDetalleVenta(id_venta) {
      axios
        .get(api_url + '/ventasCF_detalle/' + id_venta + '/')
        .then((response) => {
