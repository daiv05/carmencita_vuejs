            ...
            <div class="flex overflow-y-auto pb-36">
              <div class="w-3/4 pr-4 h-full pt-4">
                ...
                <table class="table-fixed w-full shadow-lg">
                  ...
                  <tbody>
                    <tr
                      v-for="(item, i) in CFSale.detallecredito"
                      :key="item.id_creditofiscal"
                    ...
                    >
                      ...
                      <td class="text-center">
                        $ {{ Number(item.producto.precio_unitario).toFixed(4) }}
                      </td>
                      <td class="text-center">
                        $ {{ Number(item.subtotal_detalle_credito).toFixed(2) }}
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="w-1/4 border-l border-gray-300 pl-2 flex-shrink-0 min-w-[1/8px]">
                <div class="flex md:flex-row flex-col items-center py-4 px-4">
                  ...
                  <div class="flex flex-col md:mr-16">
                    ...
                    <input
                      ...
                      disabled
                      v-model="CFSale.fecha_credito"
                    />
                  </div>
                </div>

                <div
                  class="flex flex-shrink-0 min-w-[8px] md:flex-row flex-col items-center py-4 px-4"
                >
                  ...
                  <div class="flex flex-col md:mr-16">
                    ...
                    <input
                      ...
                      v-model="CFSale.cliente.nombre_cliente"
                      disabled
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="flex flex-col md:mr-16">
                    <label
                      for="distintivo_cliente"
                      class="text-black-800 text-sm font-bold leading-tight tracking-normal mb-2"
                    >
                      Distintivo cliente
                    </label>
                    <input
                      id="distintivo_cliente"
                      type="text"
                      name="nombre_cliente"
                      class="text-slate-600 focus:outline-none focus:border focus:border-indigo-700 bg-white font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                      v-model="CFSale.cliente.distintivo_cliente"
                      disabled
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="flex flex-col md:mr-16">
                    ...
                    <input
                      ...
                      name="nombre_cliente"
                      class="text-slate-600 focus:outline-none focus:border focus:border-indigo-700 bg-white font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                      v-model="CFSale.cliente.nit_cliente"
                      disabled
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="flex flex-col md:mr-16">
                    ...
                    <input
                      ...
                      name="nombre_cliente"
                      class="text-slate-600 focus:outline-none focus:border focus:border-indigo-700 bg-white font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                      v-model="CFSale.cliente.nrc_cliente"
                      disabled
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="flex flex-col md:mr-16">
                    ...
                    <input
                      ...
                      name="nombre_cliente"
                      class="text-slate-600 focus:outline-none focus:border focus:border-indigo-700 bg-white font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                      v-model="CFSale.cliente.dui_cliente"
                      disabled
                    />
                  </div>
                </div>
...
export default {
  ...
  methods: {
    getDetalleVenta(id_creditofiscal) {
      axios
        .get(api_url + '/creditos_detalle/' + id_creditofiscal + '/')
        .then((response) => {
