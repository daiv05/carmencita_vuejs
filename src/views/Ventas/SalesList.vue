      ...
      <div>
        <div class="flex bg-white mx-auto p-5 shadow-md justify-between">
          ...
          <div class="flex items-center rounded-[4.44px] bg-blue-700 hover:bg-blue-800">
            <router-link
              to="/facturacion/registrar_nueva_venta"
              class="text-white w-auto h-auto m-2 text-[13px] font-medium text-center"
                      ...
                      <table class="table-fixed w-full shadow-lg">
                        ...
                        <tbody class="table-group-divider" id="contenido">
                          ...
                          >
                            ...
                            <td
                              v-text="formatearFechas(venta.fecha_venta)"
                              class="text-center"
                            ></td>
                            <td class="text-center">Consumidor Final</td>
                            <td
                              v-text="'$ ' + Number(venta.total_venta).toFixed(2)"
                              class="text-center"
                            ></td>
          ...
          <div v-if="activeTab === 1" class="p-4 bg-white">
            <div class="flex max-h-[400px] overflow-y-auto pb-36">
              <div class="pr-4 pt-4">
                ...
                <p
                  class="mt-2 flex-grow-0 flex-shrink-0 w-[700px] text-[20px] font-semibold text-right text-[#3056d3]"
                >
                    ...
                    <div class="table-responsive">
                      <table class="table-fixed w-full shadow-lg">
                        ...
                        <tbody class="table-group-divider" id="contenido">
                          ...
                          <tr
                            v-else
                            v-for="(venta, i) in CFSales"
                            :key="venta.id_creditofiscal"
                            class="border-b-2 border-black-400 h-[40px] bg-black-300"
                          >
                            <td v-text="i + 1" class="text-center"></td>
                            ...
                            <td
                              v-text="formatearFechas(venta.fecha_credito)"
                              class="text-center"
                            ></td>
                            <td class="text-center">Credito Fiscal</td>
                            <td
                              v-text="'$' + Number(venta.total_credito).toFixed(2)"
                              class="text-center"
                            ></td>
                            <td class="text-center flex">
                              <router-link
  ...
  methods: {
    ...
    eleminarVentaCF: function (venta, id_venta) {
      if (confirm('¿Está seguro que desea eliminar la venta?')) {
        axios
          .delete(api_url + '/ventasCF/' + venta.id_venta)
          .then((res) => {
            console.log(res)
