      ...
      <section class="grid grid-row-2 gap-5 w-[90%] m-auto">
        <article class="grid grid-cols-7 gap-1">
          <div class="grid grid-rows-3 gap-1 col-span-1 mr-2">
            ...
            <Field
              type="date"
              class="rounded p-2 h-[40px]"
              v-model="fechaInicioVenta"
              name="fecha_inicio"
              :rules="validarFecha"
            />
          ...
          <div class="grid grid-cols-2 gap-2 col-span-2">
            <div class="grid grid-rows-3 gap-1 mr-2">
              ...
              <Field
                type="number"
                step="0.15"
                class="rounded p-2 h-[40px] w-[80%]"
                name="min_total"
                min="0"
                id="minTotal"
                v-model="minTotal"
                :rules="validarMinTotal"
              />
          ...
          <div class="grid grid-cols-2 gap-1 col-span-2">
            <div class="grid grid-rows-3 gap-1 mr-2">
              ...
              <Field
                type="number"
                step="0.15"
                class="rounded p-2 h-[40px] w-[60%]"
                name="min_total_producto"
                v-model="minTotalProducto"
                :rules="validarMinTotalProducto"
                min="0"
              />
            ...
            <div class="grid grid-rows-3 gap-1 font-bold mr-2">
              ...
              <Field
                ...
                step="0.15"
                class="rounded p-2 h-[40px] w-[60%]"
                :rules="validarMaxTotalProducto"
                name="max_total_producto"
                v-model="maxTotalProducto"
                min="0"
              />
          ...
          <div class="flex justify-center align-center">
            <button class="bg-indigo-700 text-white h-[30%] rounded mt-[28%] p-[5px]">
              Aplicar Filtro
            </button>
          </div>
        </article>
  ...
  methods: {
    ...
    validarMaxTotalProducto(value) {
      if (value < 0) {
        ...
        this.maxTotalProducto != null &&
        this.maxTotalProducto >= this.minTotalProducto
      ) {
