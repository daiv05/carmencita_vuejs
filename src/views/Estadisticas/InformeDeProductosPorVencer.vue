      ...
      <div class="grid grid-cols-1">
        ...
        <section class="grid-cols-1">
          <section class="mx-auto p-6">
            <span class="text-[#3056d3]"
              >Fecha actual: {{ formatearFechas(productosPV.fecha_actual) }}</span
            >
            <p
              class="mt-2 flex-grow-0 flex-shrink-0 text-md font-semibold text-left text-[#727171]"
            >
